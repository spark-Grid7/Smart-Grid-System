...
export const Hardware = () => {
  ...
  useEffect(() => {
    ...
    const basePath = `${auth.currentUser.uid}/hardware/${linkedId}`;
  ...
  const handleLinkHardware = async () => {
    ...
    try {
      ...
      const basePath = `${uid}/hardware/${mac}`;
  ...
  const handleUnlink = async () => {
    ...
    try {
      ...
      const basePath = `${uid}/hardware/${linkedId}`;
              ...
              <div>
                ...
                <div className="mt-2 flex flex-col gap-2">
                  ...
                  <p className="text-[10px] text-slate-400 font-mono mt-1">
                    Realtime Database Path: <span className="text-emerald-600">/{auth.currentUser?.uid}/hardware/{linkedId}</span>
                  </p>
                </div>
              </div>
            </div>
